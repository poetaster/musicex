...
Page {
  ...
  property string default_playlist_file: StandardPaths.music + '/music_explorer/playlist.pls'
    ...
    PullDownMenu {
      ...
      MenuItem {
        ...
        onClicked: {
          ...
          console.log(python.save_playlist(default_playlist_file, playlist_items))
        }
      }
    }
  ...
  Component {
    ...
    FolderPickerPage {
      ...
      onSelectedPathChanged: {
        ...
        const local_media = python.get_media_folder_items(selectedPath)
        for (var i = 0; i < local_media.length; i++) {
          console.log('folder_picker_page - media:', local_media[i])
          main_handler.add_playlist_item(local_media[i])
        }
      }
    }
